...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Maintenance Control Room"),
    React.createElement("p", null, "Maintenance plans, asset work orders, asset health posture, and downtime-aware follow-up."),
    React.createElement(
      "p",
      null,
