# Maintenance & CMMS Core Agent Context
...
- Package root: `framework/builtin-plugins/maintenance-cmms-core`
- Service layer: `framework/builtin-plugins/maintenance-cmms-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/maintenance-cmms-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/maintenance-cmms-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/maintenance-cmms-core/src/ui`

## Safe assumptions

- Use `maintenance-cmms-core` as the stable plugin identifier and `@plugins/maintenance-cmms-core` as the package import name.
