# Maintenance & CMMS Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `maintenance-cmms-core` and its owned resource set.
...
- ERP parity references are tracked against: `Maintenance`, `Assets`.
