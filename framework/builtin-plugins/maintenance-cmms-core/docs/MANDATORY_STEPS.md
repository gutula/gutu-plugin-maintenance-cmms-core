# Maintenance & CMMS Core Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/maintenance-cmms-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `maintenance-cmms-core` and the package import `@plugins/maintenance-cmms-core`.
