...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/maintenance-cmms-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-maintenance-cmms-core:");
...
console.log("Documentation check passed for gutu-plugin-maintenance-cmms-core.");
